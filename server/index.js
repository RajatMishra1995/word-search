    ...
    var endTurn = function () {
      ...
      for (var i = 0, len = wordList.length; i < len; i++) {
        ...
        if (wordList[i] === curWord) {
          ...
          document.getElementById('score').innerHTML =  'Your Score : ' + scoreManager.getScore();
          wordList.splice(i,1);
...
// starts the timer and brings up the score
(function() {
  ...
  function enableSolveAndNewGameButtons() {
